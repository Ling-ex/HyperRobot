...
────────────────────────
× *Up☠ ꜱᴀʏᴀ ᴀᴅᴀʟᴀʜ ʙᴏᴛ ᴛᴇᴍᴀ ᴡɪʙᴜ ʏᴀɴɢ ᴅɪʀᴀɴᴄᴀɴɢ ᴜɴᴛᴜᴋ ᴍᴇᴍʙᴀɴᴛᴜ ᴍᴇɴɢᴇʟᴏʟᴀ ᴅᴀɴ ᴍᴇᴍᴜᴛᴀʀ ᴍᴜꜱɪᴋ ɢʀᴜᴘ ᴛᴇʟᴇɢʀᴀᴍ ᴀɴᴅᴀ ᴅᴇɴɢᴀɴ ʙᴀɴʏᴀᴋ ꜰɪᴛᴜʀ.
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="emiko_"),
