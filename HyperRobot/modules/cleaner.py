...
from HyperRobot import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from HyperRobot.modules.sql import cleaner_sql as sql
...
__help__ = """
 Pembersih teks biru menghapus semua perintah yang dibuat-buat yang dikirim orang di obrolan Anda.

❂ /cleanblue <on/off/yes/no>*:* bersihkan perintah setelah mengirim
❂ /ignoreblue <word>*:* mencegah pembersihan otomatis dari perintah
❂ /unignoreblue <word>*:* hapus cegah pembersihan otomatis dari perintah
...
❂ /gignoreblue <word>*:* secara global mengabaikan pembersihan teks biru dari kata yang disimpan di seluruh Saitama.
