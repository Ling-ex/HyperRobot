RUN_STRINGS = (
    ...
    "Hei bertanggung jawab atas apa yang baru saja Anda lakukan!",
    ...
    "Seperti yang akan dikatakan The Doctor... RUN!",
)
...
SLAP_TEMPLATES = (
    ...
    "{user2} dapatkan rekt.",
    "{user2}'s melon dibelah oleh {user1}.",
    ...
    "{user2} di kirim ke black hole. - '{user1}' ",
    ...
    "{user1} pokes {user2} di mata !",
    "{user1} pokes {user2} di samping!",
    "{user1} pokes {user2}!",
    "{user1} pokes {user2} dengan jarum!",
    "{user1} pokes {user2} dengan pena!",
    "{user1} pokes {user2} dengan pistol setrum!",
