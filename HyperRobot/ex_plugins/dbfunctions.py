...
from HyperRobot.mongo import db

# BEBERAPA HAL TERJANGKAU DI SINI, SEPERTI TOGGLEABLES PUNYA KOLEKSI SENDIRI
# (HARUS MEMPERBAIKINYA DENGAN SESUATU SEPERTI TOGGLEDB), KEBANYAKAN KODE AF BURUK
# DAN PERLU DITULIS ULANG, TAPI SAYA TIDAK MAU, KARENA AKAN MEMBUTUHKAN
# TERLALU BANYAK WAKTU DAN AKAN BURUK UNTUK DATA YANG SUDAH TERSIMPAN
